...
<input
    ...
    type="checkbox" 
    value="Yes"
    {{ $user->address == '$user->address' ? 'checked' : '' }}
    data-toggle="toggle"
    data-on="Yes"
    data-off="No" {{$user->address != '$user->address' ? 'checked' : ''}} data-onstyle="primary" 
    data-offstyle="info" 
>
...
<table>
  ...
  <br>
  <!-- <tr><input type="checkbox" name="check_box" value="1" onclick="1"></tr> -->
  <br>
          <tr style="background-color:grey;">
          <td style="padding:20px;">Custome Name</td>
          <td style="padding:20px;">Phone </td>
